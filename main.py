...
# PARSE NOMOR & OTP
# =======================
# Fungsi scraping dari kode sebelumnya tetap digunakan
...
async def process_user_input(browser_context, user_id, prefix, message_id_to_edit=None):
    ...
    try:
        ...
        await page.goto(SCRAPE_URL, wait_until="load", timeout=20000)
        ...
        # Menggunakan expect_navigation dengan timeout singkat (5 detik) untuk memastikan proses klik selesai
        try:
...
# =======================
# TELEGRAM LOOP (TIDAK BERUBAH LOGIKA UTAMA)
# =======================
...
async def main():
    ...
    async with async_playwright() as p:
        try:
            # Connect ke Chrome yang sudah ada
            browser = await p.chromium.connect_over_cdp("http://localhost:9222")
            
            # Kita menggunakan context pertama dari browser yang terhubung
            # Ini penting agar semua page/tab baru dibuka dalam konteks yang sama
